...
```{r echo=FALSE, fig.height=4, fig.width=8, message=FALSE, warning=FALSE, paged.print=TRUE}
file_path_pa <- system.file("extdata", "marburg_parameter.csv", package = "epireview")
if(file_path_pa=="") file_path_pa <- paste0('../extdata/marburg_parameter.csv')
...
```{r echo=FALSE, fig.height=4, fig.width=8, message=FALSE, warning=FALSE, paged.print=TRUE}
test <- system.file("extdata", "marburg_outbreak.csv", package = "epireview")
