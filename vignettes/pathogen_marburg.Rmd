...
source('../R/prep_data_forest_plots.R')
...
```{r echo=FALSE, fig.height=4, fig.width=8, message=FALSE, warning=FALSE, paged.print=TRUE}
df <- prep_data_forest_plots(pathogen = "marburg", prepend = "../", exclude = c(15, 17))
forest_plot_r(df)
```
...
df_out$article_label_unique <- make.unique(df_out$article_label)
df_out$article_label_unique <- factor(df_out$article_label_unique,
                                      levels = df_out$article_label_unique)
