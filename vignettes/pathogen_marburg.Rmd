...
```{r cfr_panel_A, echo=FALSE, fig.height=3, fig.width=9, message=FALSE, warning=FALSE}
library(meta)
...
```{r cfr_panel_B, echo=FALSE, fig.height=4, fig.width=9, message=FALSE, warning=FALSE}
