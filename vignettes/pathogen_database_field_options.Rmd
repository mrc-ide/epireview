...
tbl <- get_table_field_options('model',vignette_prepend = "../")
tbl %>% flextable()
```
...
tbl <- get_table_field_options('parameter',vignette_prepend = "../")
tbl %>% flextable()
```
...
tbl <- get_table_field_options('outbreak',vignette_prepend = "../")
tbl %>% flextable()
```
