...
priority_pathogens <- function() {
  data.frame(
    ...
    pathogen = c("marburg", "ebola", "lassa","sars", "zika","oropouche"),
    articles_screened = c(4460, 9563,5414,14929, 27491,496),
    articles_extracted = c(42, 520,157,288, 574,142),
    doi = c(
